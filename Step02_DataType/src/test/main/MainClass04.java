...
public class MainClass04 {
	public static void main(String[] args) {
		...
		// 2. eng, kor, math 세 점수의 합을 sum 이라는 이름의 지역 변수에 담아 보세요.
		int sum= eng+kor+math;
		// 3. eng, kor, math 의 평균값을 구래서 ave 라는 이름의 지역 변수에 담아 보세요.
		// int type 과 int type 을 연산하면 결과는 int type 만 나온다.
		// 만일 정확한 실수 값을 얻어내고 싶으면 연산에 참여하는 데이터 중에
		// 어느 하나가 실수 type 이 되어야 실수 type 이 결과로 나온다.
		double ave=(double)sum/3;  // double 이나 float는 소수점 까지 다룰때 사용한다.
